...
Pcd_transformer::Pcd_transformer()
{
  ...
  pub = nh.advertise<sensor_msgs::PointCloud2>("/" + camera_index + "/depth/transformed_points", 1);
  sub = nh.subscribe("/" + camera_index + "/depth/points", 1, &Pcd_transformer::callback, this);
}
